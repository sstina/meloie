...
"""RMVPE F0 estimator: log-mel -> DeepUnet+BiGRU -> 360-class salience -> cents -> Hz."""
...
class MelSpectrogram(torch.nn.Module):
    """128 mels / 16 kHz / win 1024 / hop 160 / fmin 30 / fmax 8000 / htk —
    semantic constants matched to rmvpe.pt's training."""
...
class RMVPE0Predictor:
    """Loads rmvpe.pt (weights_only) and infers F0 from 16 kHz audio."""
